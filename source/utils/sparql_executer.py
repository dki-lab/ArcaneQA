...
# sparql = SPARQLWrapper("http://axiom.cs.ucsb.edu:3094/sparql")
# sparql = SPARQLWrapper("http://cse-cnc238814s.cse.ohio-state.edu:3093/sparql")
# sparql = SPARQLWrapper("http://cse-cnc196739s.cse.ohio-state.edu:3093/sparql")
sparql = SPARQLWrapper("http://127.0.0.1:3094/sparql")
